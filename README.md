...
- **Circuit breakers** — Groq AI (threshold: 5 failures, 120s reset) and Docker executor (threshold: 10 failures, 60s reset) open automatically under sustained failures and recover via half-open probing.
