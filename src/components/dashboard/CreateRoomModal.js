      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="glass-panel-raised w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8"
          >

        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-black text-white tracking-tight font-[family-name:var(--font-display)]">New Interview Room</h2>
