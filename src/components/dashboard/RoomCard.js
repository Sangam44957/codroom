...
export default function RoomCard({ room, liveCount, onDeleted }) {
  ...
  return (
    ...
    >
      <div
        className="glow-orb -top-8 -right-8 h-32 w-32"
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="relative flex items-start justify-between gap-3 mb-4">
          <div className="min-w-0 flex-1">
            <h3
              className="relative text-[var(--text-body)] text-white group-hover:text-violet-300 transition-colors truncate leading-snug"
            ...
            {room.candidateName && (
              <p
                className="relative text-[var(--text-caption)] text-slate-500 mt-0.5 truncate"
                style={{ fontWeight: "var(--weight-body)" }}
              >
        ...
        {/* Action row */}
        <div className="relative flex items-center gap-2 pt-3 border-t border-white/[0.05]">
          <button
